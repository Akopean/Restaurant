...
function restaurant_scripts() {
	...
	wp_enqueue_style( 'restaurant-custom-style', get_template_directory_uri() . '/assets/css/style.css');

	wp_enqueue_script( 'restaurant-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'jquery');

	// Load  Vendor.js
	wp_enqueue_script( 'restaurant-vendor', get_theme_file_uri( '/assets/js/vendor.js' ), array( 'jquery' ), '1.0', true );
	// Load App.js
	wp_enqueue_script( 'restaurant-app', get_theme_file_uri( '/assets/js/app.js' ), array( 'jquery' ), '1.0', true );

	wp_enqueue_script( 'restaurant-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
